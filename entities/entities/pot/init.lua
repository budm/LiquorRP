...
local function TimerCheck(plant)
	...
	if timer.IsTimer("PotGrowth_" .. E) then timer.Remove("PotGrowth_" .. E) end
	if timer.IsTimer("PotGrowth2_" .. E) then timer.Remove("PotGrowth2_" .. E) end
	if timer.IsTimer("MovePlant_" .. E) then timer.Remove("MovePlant_" .. E) end
	if timer.IsTimer("KillPlant_" .. E) then timer.Remove("KillPlant_" .. E) end
end
