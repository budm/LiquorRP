...
function ENT:Use(activator,caller)
	...
	if activator ~= Owner then
		...
		GAMEMODE:Notify(activator, 0, 4, "You have paid " .. CUR .. self.dt.price .. " for using Pills.")
		GAMEMODE:Notify(Owner, 0, 4, "You have received " .. CUR .. self.dt.price .. " for selling Pills.")
	end
	DrugPlayer(caller)
	self.CanUse = false
	self:Remove()
