...
local function ChangeJobVGUI()
	if not F4Menu or not F4Menu:IsValid() then
		...
		F4Menu:MakePopup( )
		F4Menu:SetTitle("Game Options")
		F4Tabs = { GAMEMODE:HELPTab(), GAMEMODE:MoneyTab(), GAMEMODE:JobsTab(), GAMEMODE:EntitiesTab(), GAMEMODE:RPINVTab()}
	...
	if not F4MenuTabs or not F4MenuTabs:IsValid() then
		...
		F4MenuTabs:SetPos(5, 40)
		F4MenuTabs:SetSize(760, 550)
		--The tabs: Look in showteamtabs.lua for more info
		F4MenuTabs:AddSheet("Help/FAQ(CD)", F4Tabs[1], "icon16/user_suit.png", false, false)
		F4MenuTabs:AddSheet("Commands(CL)", F4Tabs[2], "icon16/money.png", false, false)
		F4MenuTabs:AddSheet("Jobs(RW?)", F4Tabs[3], "icon16/user_suit.png", false, false)
		F4MenuTabs:AddSheet("Store(CD)", F4Tabs[4], "icon16/cart.png", false, false)
		F4MenuTabs:AddSheet("Inventory(CD)", F4Tabs[5], "icon16/user_suit.png", false, false)		
	end
